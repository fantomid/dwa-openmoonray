...
export PXR_PLUGINPATH_NAME=${install_root}/lib/usd:${omr_root}/plugin/usd/moonrayShaderDiscovery:${omr_root}/plugin/usd/moonrayShaderParser:${omr_root}/plugin/usd:${omr_root}/plugin/pxr:${PXR_PLUGINPATH_NAME}
export PXR_PLUGIN_PATH=${install_root}/lib/usd:${omr_root}/plugin/usd/moonrayShaderDiscovery:${omr_root}/plugin/usd/moonrayShaderParser:${omr_root}/plugin/usd:${omr_root}/plugin/pxr:${PXR_PLUGIN_PATH}
